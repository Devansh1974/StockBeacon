...
const AIChatbot = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:6900'}/api/chat`, { query: userInput }, { withCredentials: true });
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:6900'}/api/analyze-file`, formData, {
