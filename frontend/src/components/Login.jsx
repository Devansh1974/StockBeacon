...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:6900'}/login`, {
        credentials: 'include',
        method: 'POST',
  ...
  const handleGoogleLogin = () => {
    window.open(`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:6900'}/auth/google`, '_self');
  };
